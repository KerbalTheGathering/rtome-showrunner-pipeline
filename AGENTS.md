...
If your framework loads skills from `.claude/skills/`, seven thin routers
are provided (season-status, start-season, develop-a-film, shoot-a-film,
verify-work, publish-and-deliver, fix-a-render). They point into the docs;
